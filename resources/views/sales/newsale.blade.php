    ...
    <div class="container-fluid">
        ...
        <div>
            <div class="row">S
                <div class="col-8">
                    <div>
                        <h2 class="text-light">Nueva venta</h2>
                        <hr>
                        <a class="btn btn-success" href="#">Añadir nuevo cliente</a>
                        <hr>
                        <h5 class="text-arg">Cliente</h5>
                        ...
                        <hr>
                        <h5 class="text-arg">Añadir productos</h5>
                        <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-12 row">
                                                <div class="col-2">
                                                    <button type="button" class="active bg-dark border border-1 border-arg rounded-2 p-1 position-relative">
                                                        <img src="{{asset('img/product_thumbnail/airpod_2_gen.jpg')}}" class="mini-prod-thumbnail" alt="...">
                                                    </button>
                                                </div>
                                                <div class="col-10 my-auto text-start ms-0 ps-0">
                                                    <span class="me-2 text-arg">Apple Airpods Pro 2°gen</span>
                                                    <span class="badge text-dark bg-light">Blanco</span>
                                                </div>                            
                                            </div>
                                        </td>
                                        <td>
